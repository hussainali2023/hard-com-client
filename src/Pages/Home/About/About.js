...
const About = () => {
  return (
    <div className="my-8 md:my-24 mx-16 shadow-lg">
      <p className=" mb-8">
        <hr />
      </p>
      <div className=" grid grid-cols-1 md:grid-cols-2 md:gap-20 ">
        ...
        >
          ...
          <p className=" md:text-lg mt-10 md:mt-20">
            HARD-COM Shop is the one-stop PC store since 2020 in Kolkata for all
            your computer needs. <br /> <br />
            We specialize in refurbished gaming PC, workstation, desktop
            computers, and custom PC build as per your own selected PC
            components.
            <br /> <br />
            We also deals in all type of computer parts & accessories specially
            in gaming collection.
          </p>
        </div>
                    ...
                    <div className="mb-8 flex w-full max-w-[370px] text-white">
                      ...
                      <div className="w-full">
                        ...
                        <p className="text-body-color text-base">
                          99 S.t Jomblo Park New Delhi 28292. India
                        </p>
                      </div>
                    </div>
                    <div className="mb-8 flex w-full max-w-[370px] text-white">
                    ...
                    <div className=" rounded-lg bg-white p-8">
                      <form>
                        ...
                        <div className="justify-center mt-4">
                          <button className=" btn bg-orange-400 hover:bg-white hover:text-orange-400 hover:font-medium  py-2 border-2 border-orange-400 rounded-3xl text-white w-full">
                            Send Message
                          </button>
                        </div>
                      </form>
